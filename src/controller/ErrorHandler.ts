...
namespace typescript.example.ui5app.controller
{
    @UI5("typescript.example.ui5app.controller.ErrorHandler")
    export class ErrorHandler extends UI5Object
    {
...
export default typescript.example.ui5app.controller.ErrorHandler;
